...
class TestLeafNode(unittest.TestCase):
    ...
    def test_leaf_to_html_img_with_props(self):
        node = LeafNode(
            "img",
            "hello, world!",
            {"src": "/home/user/Pictures/test_image1.png", "alt": "test image"},
        )
        self.assertEqual(
            node.to_html(),
            '<img src="/home/user/Pictures/test_image1.png" alt="test image">hello, world!</img>',
        )
    ...
    def test_leaf_to_html_link_with_props(self):
        node = LeafNode(
            "a",
            "hello, world!",
            {"class": "greeting", "href": "https://boot.dev", "target": "_blank"},
        )
        self.assertEqual(
            node.to_html(),
            '<a class="greeting" href="https://boot.dev" target="_blank">hello, world!</a>',
        )
...
class TestParentNode(unittest.TestCase):
    ...
    def test_to_html_with_children_and_props(self):
        ...
        self.assertEqual(
            parent_node.to_html(),
            '<div><img src="/home/user/Pictures/test_image1.png" alt="test image"></img></div>',
        )
