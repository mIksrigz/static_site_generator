...
class TestTextNode(unittest.TestCase):
    ...
    def test_eq_with_equal_url(self):
        node = TextNode(
            "This is a text node", TextType.IMAGE, "/home/miksr/images/image1.png"
        )
        node2 = TextNode(
            "This is a text node", TextType.IMAGE, "/home/miksr/images/image1.png"
        )
...
class Test_Text_Node_To_Html_Node(unittest.TestCase):
    ...
    def test_image(self):
        node = TextNode(
            "This is a image node", TextType.IMAGE, "/home/user/pictures/test_image.png"
        )
        html_node = text_node_to_html_node(node)
        ...
        self.assertEqual(
            html_node.props,
            {"src": "/home/user/pictures/test_image.png", "alt": node.text},
        )
